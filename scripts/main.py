                        ...
                        html.Div(
                            [
                                dcc.Dropdown(
                                    ...
                                    clearable=False,
                                    searchable=False,
                                    className="small-dropdown-child",
                                ),
                            ],
                            className="small-dropdown-wrapper",
                        ),
                        dcc.Graph(id="productbar", figure={}, className="chart-container")
                    ],
...
def update_choropleth_map(year, region):
    ...
    def create_placeholder_figures(filtered_df, region):
        ...
        return topbarfig, bottombarfig, productbar
    ...
    topbarfig, bottombarfig, productbar = create_placeholder_figures(filtered_df, region)


    return choropleth_map_urls.get(year), topbarfig, bottombarfig, productbar
